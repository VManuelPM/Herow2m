package com.w2m.utils;

public final class ApplicationConstants {
  public static final String API_TITLE = "Heroes API";
  public static final String VERSION = "2.0";
  public static final String HEROE_TITLE = "Heroes";
  public static final String HEROE_DESCRIPTION = "Operations with heroes";
  public static final String HEROE_GET = "Get all Heroes";
  public static final String HEROE_BY_ID = "Get Heroe By ID";
  public static final String HEROE_BY_NAME = "Get Heroe By Name";
